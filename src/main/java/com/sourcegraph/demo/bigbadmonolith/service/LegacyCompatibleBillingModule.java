...
public class LegacyCompatibleBillingModule implements BillingContract {

    private final BillableHourDAO billableHourDAO;
    private final BillingCategoryDAO categoryDAO;
    private final CustomerDAO customerDAO;

    public LegacyCompatibleBillingModule(BillableHourDAO billableHourDAO, BillingCategoryDAO categoryDAO, CustomerDAO customerDAO) {
