...
| T-0006 | DONE | Confirm loop-1 billing spec is current and aligned with latest baseline | T-0005 | MODULE_REWRITE_PHASE3B_BILLING.md exists and includes FR -> AT -> BR mapping |
