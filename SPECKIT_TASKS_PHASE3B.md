...
| T-0005 | DONE | Recreate phase-3 target architecture artifact with explicit module boundaries | T-0004 | TARGET_ARCHITECTURE_PHASE3.md exists and includes boundary definitions + trace matrix |
...
2. T-0006 Confirm loop-1 billing spec is current and aligned with latest baseline.
3. T-0003 Record local runbook commands for this workspace.
4. T-0012 Resolve any billing parity mismatches found in dual-run.
5. T-0013 Cut over traffic to rewritten billing module with rollback switch retained.
